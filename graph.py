...
def get_image_processing_builder():
    builder = StateGraph(ImageProcessingState, input=ImageProcessingStateInput, output=ImageProcessingStateOutput, config_schema=ConfigSchema)
...
def get_translation_graph_builder():
    builder = StateGraph(TranslationState, input=TranslationStateInput, output=TranslationStateOutput, config_schema=ConfigSchema)
